...
export declare class MovieDb {
    ...
    movieWatchProviderList(params: types.WatchProvidersParams, axiosConfig?: AxiosRequestConfig): Promise<types.WatchProviderListResponse>;
    ...
    tvWatchProviderList(params: types.WatchProvidersParams, axiosConfig?: AxiosRequestConfig): Promise<types.WatchProviderListResponse>;
